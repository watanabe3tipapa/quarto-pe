...
date: last-modified
description: |
  Quarto qmd ファイルのコード実行機能（Rチャンク・パラメータ化・Observable JS・インラインコード）のテンプレート集。
lang: ja
toc: true
...
平均: <code>r mean_x</code>、標準偏差: <code>r sd_x</code>
````
...
本日のテストは **<code>r total</code> 問中 <code>r passed</code> 問** 合格でした。
合格率は **<code>r round(rate, 1)</code>%** です。
````
